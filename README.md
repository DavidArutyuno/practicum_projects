...
1. Клонируйте [этот репозиторий](https://github.com/DavidArutyuno/django-sprint4/) на свой компьютер
...
5. Загрузите данные из файла db.json в базу данных:

        python manage.py loaddata db.json

6. Запустите сервер разработки (виртуальное окружение должно быть активно):

        python manage.py runserver

7. Откройте [ссылку](http://127.0.0.1:8000/) в любом браузере и насладитесь успехом
