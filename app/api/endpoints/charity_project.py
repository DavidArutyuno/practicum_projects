...
async def get_all_charity_projects(
    ...
    """Показать список всех целевых проектов (доступно всем)."""
...
async def create_charity_project(
    ...
    """Создать целевой проект (только для суперпользователя)."""
...
async def update_charity_project(
    ...
    """
    Редактировать целевой проект (только для суперпользователя).
...
async def delete_charity_project(
    ...
    """
    Удалить целевой проект (только для суперпользователя).
